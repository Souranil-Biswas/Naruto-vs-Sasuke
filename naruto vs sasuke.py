...
ShurikenS = pygame.mixer.Sound("pics\\shuriken.wav")
bgm = pygame.mixer_music.load("pics\\naruto.mp3")
...
class player():
    ...
    def draw(self,win):
        ...
        if self.health >0:
            ...
            self.hitbox = (self.x +10 ,self.y +5 ,80,80)
            Nbar2 = pygame.draw.rect(win,(255,0,0),(80,40,200,25))
            Nbar1 = pygame.draw.rect(win,(255,255,0),(80,45,self.health,15))
        
        else:
            win.blit(pygame.image.load("pics\\Nd.png"),(self.x,self.y))
            text = font.render('You DIED',True,(255,100,10),(0,0,100))
...
class enemy():
    ...
    def draw(self, win):
        ...
        Sbar1 = pygame.draw.rect(win,(255,255,0),(420,45,self.health,15))

        if self.health == 0:

            self.speed = 0
            text = font.render('You WON',True,(255,100,10),(0,0,100))
            win.blit(text,(100,150))
